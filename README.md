...
To get the applicable prices for a product on a given date, we could have written a raw SQL query like this:
```
SELECT *
FROM PRICES
...
This query would directly return the prices that apply for the given date.
...
public interface PriceRepository extends JpaRepository<PriceEntity, Long> {
    ...
    Optional<PriceEntity> findByBrandIdAndProductIdAndStartDateLessThanEqualAndEndDateGreaterThanEqual(
            Long brandId,
            Long productId,
